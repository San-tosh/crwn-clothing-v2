...
import {sagaActions as categoriesAction} from "./categories.action";

export function* fetchCategoriesAsync() {
    try {
        const categoryArray = yield call(getCategoriesAndDocuments,'categories'); // yield pauses until it gets back something similar to await
